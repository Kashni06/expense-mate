...
export default function Friends() {
  ...
  return (
    <div>
      ...
      {/* MODAL (CONSISTENT WITH OTHER PAGES) */}
      {showModal && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-gray-900 text-white rounded-xl p-6 w-[380px]">
            ...
            <input
              className="w-full mt-2 mb-4 px-3 py-2 rounded-lg bg-gray-800 border border-gray-700 focus:outline-none"
            ...
            <input
              type="number"
              className="w-full mt-2 px-3 py-2 rounded-lg bg-gray-800 border border-gray-700 focus:outline-none"
              placeholder="+ gets / - owes"
              value={amount}
